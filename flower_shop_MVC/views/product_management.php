...
<body class="site-container">
    <main class="main-content">
        ...
        <div class="container mt-4 product-management-page">
            <div class="d-flex justify-content-between align-items-center mb-4 flex-column flex-md-row gap-2">
                ...
                <button class="btn btn-success btn-mobile-full w-md-auto" data-bs-toggle="modal"
                    data-bs-target="#modalProduct">
                    Thêm sản phẩm mới
                </button>
            </div>
            <!--Thanh tìm kiếm sản phẩm-->
            <div class="card mb-4 shadow-sm product-management-search-card">
                <div class="card-body">
                        ...
                        if (!empty($products))
                            foreach ($products as $row) { ?>
                                <tr>
                                    ...
                                    <td><img src="assets/images/image_products/<?php echo $row['image'] ?>"
                                            class="rounded image_icon" alt="product">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#modalModify" onclick="openEditModal(
                                        <?= $row['id_product'] ?>,
