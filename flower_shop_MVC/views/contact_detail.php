        ...
        <div class="container my-5">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <?php else: ?>
                        <!-- Bảng hiển thị lịch sử liên hệ của khách hàng -->
                        <div class="table-responsive shadow-sm rounded-4 bg-white p-3">
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <!-- Duyệt qua các liên hệ và hiển thị thông tin chi tiết -->
                                    <?php foreach ($contacts as $item): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if (!empty($item['reply'])): ?>
                                                    <span class="badge rounded-pill bg-success-subtle text-success px-3">Hoàn
                                                        thành</span>
                                                <?php else: ?>
                                                    <span class="badge rounded-pill bg-warning-subtle text-warning px-3">Đang xử
                                                        lý</span>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
