                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($cartItems as $id => $item):
                                    ...
                                    ?>
                                    <tr id="cart-row-<?php echo $productId; ?>" data-product-id="<?php echo $productId; ?>"
            ...
            <div class="col-lg-4">
                <div class="p-4 bg-light border" style="top: 90px;">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        <span>Tạm tính</span>
                        <span id="subtotalAmount"><?php echo number_format($total); ?> đ</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        ...
                        <span id="grandTotalAmount" class="fw-bold fs-5 text-danger"><?php echo number_format($total); ?>
                            đ</span>
                    </div>
